...
1. PashuSetu (पशुसेतू — "the bridge for livestock") is a **marketplace web app** where farmers in rural Maharashtra sell cows, buffaloes, he-buffaloes (रेडा — a male breeding/draft buffalo), bulls/oxen, goats and sheep.
...
| C-10 | Species picker | 6-item icon grid (large), chip row (compact, for filters) | default · selected · disabled |
