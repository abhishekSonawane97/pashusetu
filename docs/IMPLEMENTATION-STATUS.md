...
| S-10a | Wizard step 1: species & breed | ✅ VERIFIED | 6-species array (adds REDA); live `/meta/breeds?species=COW` 200 (11 breeds); species change refetch. Canonical enum owned by 07 | Rendered as text pills, not spec'd icon grid |
