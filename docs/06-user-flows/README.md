...
| S-10a | — Step 1: species & breed | जनावर व जात निवडा ("choose animal & breed") | Icon grid of 5 species (REDA/रेडा retired — not listable); breed picker filtered by species (`GET /meta/breeds?species=`), incl. "गावठी / स्थानिक" (local/crossbred). (Canonical Species enum owned by doc 07.) | S-10 entry, back from S-10b | Select species + breed → S-10b |
